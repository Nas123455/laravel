                        ...
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            ...
                            <form action="{{ route('account.authenticate') }}" method="post">
                                ...
                                <div class="row gy-3 overflow-hidden">
                                    ...
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <button class="btn btn-primary py-3" type="submit">Login Now</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-center">
                                        <a href="{{ route('account.register') }}" class="link-secondary text-decoration-none">Click here to register</a>
                                    </div>
                                </div>
                            </div>
                        </div>
